...
def add_gallery(gallery, feature, label):

    if not label in gallery:
        gallery[label] = [feature]
    else:
        gallery[label].append(feature)
...
parser.add_argument('--data', default='/home/jm/workspace/face_recognition/sphereface_pytorch/data/lfw.zip', type=str)
